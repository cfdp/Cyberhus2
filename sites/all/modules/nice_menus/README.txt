...
The module includes a default CSS layout file (nice_menus_default.css) which is loaded for all pages.  
...
Really this is just about knowing your CSS and styling it the way you want it.
