...
?><div class="faq_category_group">
  ...
  <?php if (count($nodes)): ?>
    <?php foreach ($nodes as $i => $node): ?>
	  ...
	  <?php // print substr($node['body'],0,strpos($node['body'],'<p>',strpos($node['body'],'<p>')+1)); ?>
	  <?php // print '<div style="font-weight:bold">'.t("Answer").': </div>'; ?>
	  <?php // print substr($node['body'],strpos($node['body'],'<p>',strpos($node['body'],'<p>')+1)); ?>
	  <?php // var_dump($node); ?>
	  <?php print $node['body']; ?>
