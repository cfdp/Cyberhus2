...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="main"><div id="main-inner" class="clear-block<?php if ($search_box or $primary_links or $secondary_links or $navbar) { print ' with-navbar'; } ?>">
      ...
      <div id="content"><div class="top"></div> <div id="content-inner">
      ...
      <?php if ($left): ?>
        <div id="sidebar-left"><div class="top"></div> <div id="sidebar-left-inner" class="region region-left">
          <?php print $left; ?>
        </div></div> <!-- /#sidebar-left-inner, /#sidebar-left -->
      <?php endif; ?>

      <?php if ($right): ?>
        <div id="sidebar-right"><div class="top"></div> <div id="sidebar-right-inner" class="region region-right">
          <?php print $right; ?>
