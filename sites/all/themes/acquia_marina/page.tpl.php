      ...
      <div id="header">
        <div id="header-wrapper" class="clearfix">
          ...
          <div id="header-first">
            <?php if ($logo): ?> 
            <div id="logo">
              <a href="<?php print('http://cyberhus.dk/lounge'); ?>" title="<?php print t('Home') ?>"><img src="<?php print $logo ?>" alt="<?php print t('Home') ?>" /></a>
            </div>
            <?php endif; ?>
            <?php if ($site_name): ?>
          ...
          <div id="header-middle">
          	<!--<a href="http://www.cyberhus.dk"><img alt="" src="http://www.cyberhus.dk/sites/default/files/cyberhusdk/billeder/layout/Cyberhus_logony.jpg" /></a>-->
      ...
      <div id="main">
        <div id="main-wrapper" class="clearfix">
          ...
          <div id="content-wrapper">
            ...
            <?php if ($content_top_menu): ?>
            <div id="content-top-menu">
              <?php print $content_top_menu; ?>
