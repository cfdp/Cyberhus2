...
/*theming af Views mere-link */
function acquia_marina_views_more($url) {
  if (stristr($url, 'lounge')) {
    return "<div class='more-link'>" . l(t('View all the cool stuff'), "http://www.cyberhus.dk".$url) . "</div>";
  } else {
