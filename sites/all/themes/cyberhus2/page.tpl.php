 ...
 * - $topbanner_link: The URL for the topbanner - depends on the section you are
 *   viewing at Cyberhus.dk
 * - $logo: The path to the logo image, as defined in theme configuration.
 * - $site_name: The name of the site, empty when display has been disabled
 *   in theme settings.
 * - $adult_backlink_image: The path to the image that links back to the main site from
 * - the adult section
 ...
 * - $adult_links (array): An array containing the navigation links for the adult section 
 *   at Cyberhus.dk
 *   
...
<div id="repeatnavbar">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
      <a href='<?php print $topbanner_link; ?>' class="homelink"><!-- /class homelink start --> 
      ...
      <?php if ($adult_backlink_image): ?>
     <div id="header-inner-backlink">
          <a href="<?php print $front_page; ?>"><img src="<?php print $base_path.$adult_backlink_image; ?>"></a>
        </div> <!-- /#header-inner-backlink -->
      <?php endif; ?>
    ...
    <?php if ($footer or $footer_message or $messages): ?>
