...
?>
<?php
  $unsubscribe_text='Afmeld nyhedsbrev';
 ?>
<?php if ($format == 'html'): ?>
  <p class="newsletter-footer"><a href="!confirm_unsubscribe_url"><?php print $unsubscribe_text ?></a>
    <BR>
    Spørgsmål eller kommentarer til Cyberhus' nyhedsbrev: <a href="mailto:info@cyberhus.dk">info@cyberhus.dk</a>
    <BR>
