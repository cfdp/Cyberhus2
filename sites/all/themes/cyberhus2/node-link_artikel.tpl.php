...
<!--picture fjernet-->
  ...
  <div class="meta">
<!--submitted by fjernet-->

  <div class="changed">

      <?php print("Ændret den: ".format_date($node->changed, $format = 'custom' , 'd.m.Y')); ?> 
  ...
  <div class="content">
	...
	<!-- Strip html from teaser lists see www.php.net/strip_tags-->
	<?php if($teaser) {
		$content=strip_tags($content, '<p><h3><a><img>');
	}
