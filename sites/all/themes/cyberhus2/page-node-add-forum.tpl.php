  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="main"><div id="main-inner" class="clear-block<?php if ($search_box or $primary_links or $secondary_links or $navbar) { print ' with-navbar'; } ?>">
      ...
      <div id="content"><div class="kol_top_center"></div> <div id="content-inner">
        ...
        <?php endif; ?>
        <?php
        /*Besked til brugere der er logget ind og vil skrive i forum*/
		global $user;
		if ($user->uid) {
			print '<div class="Advarsel">Du er logget ind. Hvis du vil sikre din anonymitet kan du logge ud <a href="http://www.cyberhus.dk/logout">Her</a></div>';
		}
		?>
        <?php if ($content_top): ?>
