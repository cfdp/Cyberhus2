...
<?php 
/*---- NUeH ----
 * Er brugeren ejer af siden eller 'vejleder for' ejeren af siden gør intet. Ellers redirect til access denied.*/
global $user;
$profile_uid = arg(1);
$profil=user_load(arg(1));
$forbindelse=user_relationships_load(array('between' => array($user->uid, $profile_uid), 'approved' => 1), array('sort' => 'name'));
if ((array_key_exists('vejleder for', $forbindelse) && in_array('NueH Vejleder',$user->roles)) || $user->uid == $profile_uid || $user->uid == '120'|| $user->uid == '1'){
