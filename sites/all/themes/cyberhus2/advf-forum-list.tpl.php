    ...
    <?php foreach ($forums as $child_id => $forum): ?>
        ...
        <?php else: ?>
          <tr id="forum-list-<?php print $child_id; ?>" class="<?php print $forum->zebra; ?> <?php print $forum->row_classes;?> in-container-<?php print $forum->container_id;?>">
			...
			<?php
				/*
			* Authors: Daniel & Stefan 23.03.2011
			* Implementation of custom made icon for individual forum topics
			* The array contains the ids of the forum topics that require custom icons
			* CAUTION In case the id's of the topic forums change, the section below has to be changed accordingly 
			* The new id has to be used as the file name of the coresponding icon file like xx.png for the normal state
			* and new_xx.png for the new posts state
			*/
			//print $forum->icon;
			if($forum_id == 0){
				...
				foreach($forum_sc_topic_ids as $forum_topic){
					if($child_id == $forum_topic){
						if($forum->new_topics){
							print "<img src=\"../sites/all/themes/cyberhus2/images/advf-forum-new-icons/new_cs.png\" width=\"50\" height=\"50\" />";
						}else{
							print "<img src=\"../sites/all/themes/cyberhus2/images/advf-forum-new-icons/cs.png\" width=\"50\" height=\"50\" />";
						}
					}
				}
				
				$forum_topic_ids = array(715,39,785,36,40,1189);
				foreach($forum_topic_ids as $forum_topic){
					if($child_id == $forum_topic){
						if($forum->new_topics){
							print "<img src=\"../sites/all/themes/cyberhus2/images/advf-forum-new-icons/new_".$child_id.".png\" width=\"50\" height=\"50\" />";
						}else{
							print "<img src=\"../sites/all/themes/cyberhus2/images/advf-forum-new-icons/".$child_id.".png\" width=\"50\" height=\"50\" />";
						}
					}
				}
			}else{
				...
				if($forum_id == 31){
					if($forum->new_topics){
						print "<img src=\"../sites/all/themes/cyberhus2/images/advf-forum-new-icons/new_1189.png\" width=\"50\" height=\"50\" />";
					}else{
						print "<img src=\"../sites/all/themes/cyberhus2/images/advf-forum-new-icons/1189.png\" width=\"50\" height=\"50\" />";
					}
				}
				if($forum_id == 316){
					if($forum->new_topics){
