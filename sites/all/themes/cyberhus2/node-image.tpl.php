...
<div id="node-<?php print $node->nid; ?>" class="node<?php if ($sticky) { print ' sticky'; } ?><?php if (!$status) { print ' node-unpublished'; } ?> clear-block">
  ...
  <div class="content">
    ...
    <div class="tegn_selv_billede">
		<?php $viewName = 'tegn_selv';
			$display_id = 'block_2';
			print views_embed_view($viewName, $display_id);
		?>
		<!-- submitted fjernet - skrives ud i viewet -->
	</div>
	
		<?php
	//her printes kommentarerne til billedet
	$viewName = 'tegn_selv';
	$display_id = 'block_3';
	print views_embed_view($viewName, $display_id);
	...
	<?php
	//her printes seneste billeder i galleriet
	$viewName = 'tegn_selv';
	$display_id = 'block_1';
	print views_embed_view($viewName, $display_id);
