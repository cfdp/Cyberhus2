...
<?php 
/*---- NUeH ----
 * Er brugeren ejer af siden? Ellers redirect til access denied.*/
global $user;
$profile_uid = arg(1);
if ((($user->uid == $profile_uid) && (in_array('NueH Vejleder',$user->roles))) || $user->uid == '120'|| $user->uid == '1'){
}
else{
...
if (in_array('NUeH Ung',$account->roles) || in_array('NueH Vejleder',$account->roles)) :?>
    	<?php if ($left): ?>
